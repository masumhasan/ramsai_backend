...
exports.getWorkoutPlanUserPrompt = exports.WORKOUT_PLAN_SYSTEM_PROMPT = void 0;
exports.WORKOUT_PLAN_SYSTEM_PROMPT = `You are a professional AI fitness coach and personal trainer. Your task is to generate a highly personalized 7-day workout plan based on a user's detailed physical profile, goals, and lifestyle.
...
const getWorkoutPlanUserPrompt = (profile) => `
...
exports.getWorkoutPlanUserPrompt = getWorkoutPlanUserPrompt;
