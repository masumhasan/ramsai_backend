...
exports.getProductLabelUserPrompt = exports.getProductBarcodeUserPrompt = exports.PRODUCT_ANALYSIS_SYSTEM_PROMPT = void 0;
const PRODUCT_ANALYSIS_SYSTEM_PROMPT = (language = 'en') => `You are an expert AI food scientist and nutritionist. Your task is to analyze details of a food product or bottled water (provided as text metadata or an image of the packaging/label) and produce a high-fidelity health and quality assessment.
...
exports.PRODUCT_ANALYSIS_SYSTEM_PROMPT = PRODUCT_ANALYSIS_SYSTEM_PROMPT;
const getProductBarcodeUserPrompt = (productName, category, ingredientsText, language = 'en') => `Please analyze this product and generate the health assessment in ${language} JSON.
Product Name: ${productName}
Category: ${category}
${ingredientsText ? `Ingredients: ${ingredientsText}` : ''}`;
exports.getProductBarcodeUserPrompt = getProductBarcodeUserPrompt;
const getProductLabelUserPrompt = (language = 'en') => `Please perform OCR and analyze the food product/bottled water packaging label shown in this image. Generate the health assessment in ${language} JSON.`;
exports.getProductLabelUserPrompt = getProductLabelUserPrompt;
